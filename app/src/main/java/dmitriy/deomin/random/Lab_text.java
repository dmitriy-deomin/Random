 ...
 */
public class Lab_text extends FrameLayout {
    ...
    public Lab_text(Context context) {
        this(context, null, 0);
    }

    public Lab_text(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Lab_text(Context context, AttributeSet attrs, int defStyle) {
